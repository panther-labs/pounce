```typescript jsx
<Box>
  <Text color="gray-100" size="large">
    This is some text
  </Text>
  <Text color="gray-100" size="medium">
    This is some text
  </Text>
  <Text color="gray-100" size="small">
    This is some text
  </Text>
  <Text color="gray-100" size="extra-small">
    This is some text
  </Text>
</Box>
```
...
```typescript jsx
<Text color="blue-600" size="large">
...
```typescript jsx
<Text color="red-200" size="large" as="p">
